...
<html>
    ...
    <body>
        <header>
            <ul>
                <li><a href="index1.html" class="current">Главная</a></li>
                <li><a href="index2.html">Виды суккулентов</a></li>
                <li><a href="index3.html">Уход за суккулентами</a></li>
                </ul>
            </header>

            <h1>Суккуленты</h1>
            <?php
            echo '<img src="img/'.(date('s') % 2 + 1).'.jpg" class="first">';
            ?>
            ...
            <?php
            echo '<img src="img/'.(date('s') % 2 + 1).'.jpg" class="second">';
            ?>
